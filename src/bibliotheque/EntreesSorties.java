...
public class EntreesSorties {
    ...
    //	Gestion des dates
    /**
     * permet la saisie d'une date au format JJ/MM/AAAA. Le jour doit être
     * compris entre 1 et 31, le mois doit être entre 1 et 12 et l'année entre
     * 1900 et 2100. Le contrôle de cohérence entre les différents champs est
     * effectué grâce à une conversion de la saisie en date. Le contrôle du
     * format de champs champ est réalisé par l'appel à la fonction lireEntier
     *
    ...
    /**
     * Affiche un libellé puis permet la saisie d'une date au format JJ/MM/AAAA.
     * Le jour doit être compris entre 1 et 31, le mois doit être entre 1 et 12
     * et l'année entre 1900 et 2100. Le contrôle de cohérence entre les
     * différents champs est effectué grâce à une conversion de la saisie en
     * date. Le contrôle du format de champs champ est réalisé par l'appel à la
     * fonction lireEntier
     *
     * @param libelle : libellé à afficher en début pour indiquer quelle saisie
     * effectuer
    ...
    /**
     * Convertit une date en chaine au format JJ/MM/AAAA. Si la date passée vaut
     * null, la chaine résultante est "nul".
     *
    ...
    /**
     * Convertit une date en chaine au format "JJ/MM/AAAA hhH mnMN ssSEC
     * msMILLISEC". Si la date passée vaut null, la chaine résultante est "nul".
     *
     * @param date date à convertir
     ...
     * @return un entier représentant les millisecondes de la date, entre 0 et
     * 999.
     */
